...
val clayCanvas = Color(0xFFF4F1FA)
val clayTextPrimary = Color(0xFF332F3A)
val clayTextMuted = Color(0xFF635F69)
val clayPrimary = Color(0xFF7C3AED)
val clayPrimaryLighter = Color(0xFFA78BFA)
val claySecondary = Color(0xFFDB2777)
val clayTertiary = Color(0xFF0EA5E9)
val claySuccess = Color(0xFF10B981)
val clayWarning = Color(0xFFF59E0B)

// Claymorphism Dark Palette
val clayCanvasDark = Color(0xFF1A1721)
val clayTextPrimaryDark = Color(0xFFF4F1FA)
val clayTextMutedDark = Color(0xFFA096B4)
val clayPrimaryDark = Color(0xFF9D5FF0)
val clayPrimaryLighterDark = Color(0xFFBBA4F5)
val claySecondaryDark = Color(0xFFE0528E)
val clayTertiaryDark = Color(0xFF38B8F2)
val claySuccessDark = Color(0xFF34C999)
val clayWarningDark = Color(0xFFF9B234)
