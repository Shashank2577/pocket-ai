...
import com.shashank.pocketai.common.processLlmResponse
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == com.shashank.pocketai.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == com.shashank.pocketai.data.BuiltInTaskId.LLM_ASK_AUDIO
